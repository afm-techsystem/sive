...
Procedencia        enum(Nacional, Internacional)    NOT NULL,
...
Lugar            enum(Domicilio, Pickup)    NOT NULL,
...
PRIMARY KEY(CodProducto, correo),
UNIQUE(IdCarrito),
FOREIGN KEY(CodProducto) REFERENCES Producto(CodProducto),
FOREIGN KEY(correo) REFERENCES Cliente(correo)
);
...
correoVendedor    varchar(40)    NOT NULL,
PRIMARY KEY(CodProducto, correoCliente),
FOREIGN KEY(CodProducto) REFERENCES Producto(CodProducto),
FOREIGN KEY(correoCliente) REFERENCES Carrito(correo),
FOREIGN KEY(correoVendedor) REFERENCES vendedor(correo)
);
